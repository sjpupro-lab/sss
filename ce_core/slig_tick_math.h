...
/* Wave-step amplitude cycle (1, 3, 10, 30, 10, 3, 1) — same shape
 * as ce_image_wave_refine's 0.01→0.1→1→3→1→0.1→0.01 but in tick
 * units. Used by the harmonic upscaler and unsharp mask. */
extern const uint8_t WAVE_STEPS[7];
